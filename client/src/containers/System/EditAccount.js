            ...
            <div className='w-3/5 flex items-center justify-center flex-auto'>
                <div className='py-6 flex flex-col gap-4 w-full'>
                    ...
                    <div className='flex'>
                        ...
                        <small className='flex-auto text-blue-500 h-16 cursor-pointer'>Đổi mật khẩu</small>
                    </div>
                    <div className='flex mb-6'>
                        ...
                        <div>
                            ...
                            <input onChange={handleUploadFile} type="file" className='appearance-none' id='avatar' />
                        </div>
                    </div>
                    <Button
                        text='Cập nhật'
